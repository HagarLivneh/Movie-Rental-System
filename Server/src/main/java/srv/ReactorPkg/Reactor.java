...
import srv.BidiMessagingProtocol;
import srv.Server;
...
public class Reactor<T> implements Server<T> {
    ...
    private ConnectedClientsReactor connections;
    ...
    @Override
    public void serve() {
        connections=ConnectedClientsReactor.getInstance();
    ...
    private void handleAccept(ServerSocketChannel serverChan, Selector selector) throws IOException {
        ...
        final NonBlockingConnectionHandler handler = new NonBlockingConnectionHandler<T>(
                readerFactory.get(),
                protocol,
                clientChan,
                this);
